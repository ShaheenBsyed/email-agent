...
This file defines the **non-negotiable operating rules** for this system.

These rules are authoritative and must be followed as-is.
Do **not** rewrite, regenerate, summarize, or replace this file unless explicitly instructed.

All work must:
- Follow directives defined in `directives/`
- Push repeatable work into deterministic scripts in `execution/`
- Treat errors as learning signals and self-anneal by improving tools and directives
- Optimize for reliability, reduced error over time, and mission-critical safety
